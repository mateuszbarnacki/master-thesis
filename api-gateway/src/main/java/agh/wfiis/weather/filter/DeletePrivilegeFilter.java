...
@Component
public class DeletePrivilegeFilter implements GatewayFilter {
    private static final String SCOPE_CLAIM = "scope";
    private final JwtDecoder jwtDecoder;

    public DeletePrivilegeFilter(JwtDecoder jwtDecoder) {
    ...
    private boolean hasDeletePrivilege(String scope) {
        return Arrays.asList(scope.split(",")).contains(Privilege.DELETE.getName());
    }
}
